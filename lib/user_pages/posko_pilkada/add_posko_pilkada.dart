...
class AddPoskoPilkada extends StatefulWidget {
  final int userId;
  final String nikKtp;
  final String noHp;
  final ApiServices apiService;
  const AddPoskoPilkada({Key? key, required this.userId, required this.nikKtp, required this.noHp, required this.apiService}) : super(key: key);

  @override
  State<AddPoskoPilkada> createState() => _AddPoskoPilkadaState();
}



class _AddPoskoPilkadaState extends State<AddPoskoPilkada> {
  Uint8List? _pdfKtp;
  ...
  Future<void> _submitPengaduan() async {
    ...
    try {
      ...
      await widget.apiService.uploadPosko(
