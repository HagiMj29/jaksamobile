...
class DetailPoskoPilkada extends StatefulWidget {
  final Result data;
  const DetailPoskoPilkada({Key? key, required this.data}) : super(key: key);

  @override
  State<DetailPoskoPilkada> createState() => _DetailPoskoPilkadaState();
}

class _DetailPoskoPilkadaState extends State<DetailPoskoPilkada> {
