...
class DetailPengaduanTindakPidanaKorupsi extends StatefulWidget {
  final Result data;
  const DetailPengaduanTindakPidanaKorupsi({Key? key, required this.data}) : super(key: key);

  @override
  State<DetailPengaduanTindakPidanaKorupsi> createState() => _DetailPengaduanTindakPidanaKorupsiState();
}

class _DetailPengaduanTindakPidanaKorupsiState extends State<DetailPengaduanTindakPidanaKorupsi> {
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
              'Uraian Singkat Laporan: ${widget.data.uraianSingkatLaporan}',
              style: TextStyle(fontSize: 18),
            ),
            SizedBox(height: 10),
            Text(
