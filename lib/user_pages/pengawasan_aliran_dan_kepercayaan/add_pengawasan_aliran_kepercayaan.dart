...
class AddPengawasanAliranKepercayaan extends StatefulWidget {
  final int userId;
  final String nikKtp;
  final String noHp;
  final ApiServices apiService;

  const AddPengawasanAliranKepercayaan({Key? key, required this.userId, required this.nikKtp, required this.noHp, required this.apiService}) : super(key: key);

  @override
  State<AddPengawasanAliranKepercayaan> createState() => _AddPengawasanAliranKepercayaanState();
}

class _AddPengawasanAliranKepercayaanState extends State<AddPengawasanAliranKepercayaan> {
  Uint8List? _pdfKtp;
  ...
  Future<void> _submitPengaduan() async {
    ...
    try {
      ...
      await widget.apiService.uploadAliran(
